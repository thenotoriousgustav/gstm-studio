  ...
  return (
    <section className='container mx-auto mt-28 max-w-full px-4 md:px-8 lg:px-10'>
      <div className='mx-auto w-full md:w-10/12'>
        <h1 className='text-center text-5xl font-light uppercase md:text-7xl'>
      ...
      <div className='mt-24 '>
        <div>
          <Image
            ...
            sizes='100vw'
          ></Image>
          <p className='mt-6 text-2xl font-light md:w-9/12'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between'>
        ...
        <div className='mt-8 w-full md:mt-0 md:w-7/12'>
          ...
          <p className='mt-2 text-lg text-secondary'>
            ...
            digital folks from several tech companies in Germany, whose products
            are now big in Indonesia.
          </p>
        </div>
      </div>
      <OurTeam />
